...
namespace CRMYonetimSistemi.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ContactInfo,CreatedAt")] Models.Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ContactInfo,CreatedAt")] Models.Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
